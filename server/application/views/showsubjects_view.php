...
<?php
		...
		print("<table border=1><tr><td>Subject Id#</td><td> Class ID</td><td> Name</td></tr>");
		foreach($rows as $row){
			 print("<tr><td><a href='http://localhost/server/index.php/showsubject?id=$row->id'>$row->id</a></td><td>$row->class_id</td><td>$row->subject_name</td></tr>");
		}
		print("</table>");
		print("<br>");
		print("<br>");
