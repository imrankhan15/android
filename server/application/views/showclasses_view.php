...
<?php
		...
		print("<table border=1><tr><td>Class Id#</td><td>Class Name</td></tr>");
		foreach($rows as $row){
			 print("<tr><td><a href='http://localhost/server/index.php/showclass?id=$row->id'>$row->id</a></td><td>$row->name</td></tr>");
		}
		print("</table>");
		print("<br>");
		print("<br>");
