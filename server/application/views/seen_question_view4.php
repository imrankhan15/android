...
<form method="post" action="http://localhost/server/index.php/seen_question5">
<table>

<tr><td>Select section</td></tr>
<tr><td>
<select name=section_id>
 <?php
    
	foreach($rows1 as $line){
        echo '<option value="' . $line->id . '">' . 'id:-...'.$line->id.' Page Seq:-'.$line->startpage.'->' .$line->endpage. '</option>';
    } 
    ?>
</select>
</td></tr>
...
<tr><td><textarea name=question id="feedback" rows="10" cols="80" > </textarea></td></tr>
