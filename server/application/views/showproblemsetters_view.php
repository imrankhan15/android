...
<?php
		...
		print("<table border=1><tr><td>ProblemSetter Id#</td><td>ProblemSetter Mobile No</td></tr>");
		foreach($rows as $row){
			 print("<tr><td><a href='http://localhost/server/index.php/showproblemsetter?id=$row->id'>$row->id</a></td><td>$row->phone_num</td></tr>");
		}
		print("</table>");
		print("<br>");
		print("<br>");
