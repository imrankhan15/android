...
<?php
		...
		print("<table border=1><tr><td>Chapter Id#</td><td>Book ID</td><td>ChapterName</td></tr>");
		foreach($rows as $row){
			 print("<tr><td><a href='http://localhost/server/index.php/showchapter?id=$row->id'>$row->id</a></td><td>$row->bookid</td><td>$row->chaptername</td></tr>");
		}
		print("</table>");
		print("<br>");
		print("<br>");
