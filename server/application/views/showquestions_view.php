...
<?php
		...
		print("<table border=1><tr><td>Question Id#</td><td>Passage ID</td><td>Question</td><td>Section ID</td></tr>");
		foreach($rows as $row){
			 print("<tr><td><a href='http://localhost/server/index.php/showquestion?id=$row->id'>$row->id</a></td><td>$row->passage_id</td><td>$row->question_text</td><td>$row->section_id</td></tr>");
		}
		print("</table>");
		print("<br>");
		print("<br>");
