...
<form method="post" action="http://localhost/server/index.php/book1/insertBookName">
<table>
...
<tr><td>Please Insert Your BookName</td></tr>
<tr><td><textarea name=bookname id="feedback" rows="10" cols="80" > </textarea></td></tr>
<tr>
<td>
